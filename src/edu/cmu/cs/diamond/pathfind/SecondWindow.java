...
class SecondWindow extends JFrame {
    ...
    public SecondWindow() {
        ...
        selectionPanel.setPreferredSize(new Dimension(280, 700));
    ...
    public void setCellRenderer(
            SavedSelectionCellRenderer savedSelectionCellRenderer) {
        savedSelections.setCellRenderer(savedSelectionCellRenderer);
    }

    public void setModel(SelectionListModel ssModel) {
        savedSelections.setModel(ssModel);
    }

    public void setHover(String hover) {
        this.hover.setText(hover);
    }
}
